<div class="row mx-auto pt-3 pb-3">
    <div id="produits" class="col-9 active">
        <div>
            <?php 
                echo (App\Controllers\Assets::homenavmenu());
            ?>
        </div>
        <div class="row">
            ...
            <div class="col-4 mt-3"> 
                <div class="">
                    <select class="selectrayon2 myrayonList form-control" name="rayon" id="changeMyRayon" url2="<?php echo base_url('filtre/getResultat'); ?>" url3="<?php echo base_url('filtre/getSlider')?>">
